...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://halrgscsvigciduvglta.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_loDrcUIUB6Ub4W11XwDrWw_riL3Zfq_';
...
<nav class="bottombar" id="bottombar" role="navigation" aria-label="Main tabs">
  ...
  function currentPageKey() {
    ...
    if (p.endsWith('main.html') || p.endsWith('index.html') || p === '/' || p === '') return 'main';
    return '';
  }
